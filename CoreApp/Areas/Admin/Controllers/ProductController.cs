...
namespace CoreApp.Areas.Admin.Controllers
{
    public class ProductController : BaseController
    {
        ...
        {
            var authorize = await _authorizationService.AuthorizeAsync(User, "PRODUCT", Operation.Read);
        ...
        {
            var model = _productService.GetAllPaging(categoryId, keyword, page, pageSize, null, null);
            return new OkObjectResult(model);
        }
